happy_cup.controller('locations_controller', function($scope, $http, $interval, $location, $filter, content_factory){
	...
	content_factory.getPageContent('locations', function (content){
		locations = content;
		console.log(content);
		$scope.locations = content;
		groupByStore = {}
	...
	function addYourLocationButton(map, marker) {
		...
		secondChild.style.backgroundImage = 'url('+staticURL+'website/resources/images/general_resources/mylocation-sprite-1x.png)';
